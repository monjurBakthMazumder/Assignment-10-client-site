            ...
            <div className=" p-5 sm:px-14 sm:py-20  border-2 rounded-lg">
                ...
                <form className="font-semibold text-lg" onSubmit={handleSubmit}>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-5 mb-5">
                        ...
                        <input type="text" name="description" defaultValue={description} required placeholder="Description" className="input input-bordered bg-transparent border-secondary w-full mt-2" />
                        </label>
                    </div>
